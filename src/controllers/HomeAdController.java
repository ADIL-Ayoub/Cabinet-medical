...
public class HomeAdController implements Initializable{
	...
	public void toVisite() {
		...
		try {
			//stage.close();
			root = FXMLLoader.load(getClass().getResource("/Vue/Visite.fxml"));
			Scene scene = new Scene(root);
			stage.setScene(scene);
	...
	public void toSecurite() {
		...
		try {
			//stage.close();
			root = FXMLLoader.load(getClass().getResource("/Vue/Securite.fxml"));
			Scene scene = new Scene(root);
			stage.setScene(scene);
			stage.setTitle("Securite");
			stage.getIcons().add(new Image("C:\\Users\\asus\\eclipse-workspace\\CabinetMedical\\src\\Icons\\transparent-heart-icon-health-care-icon-medical-services-icon-5fcbd37a03aac1.974566991607193466015.png"));
			stage.setResizable(false);
			stage.show();
		} catch (IOException e) {
